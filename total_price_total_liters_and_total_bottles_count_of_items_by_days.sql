--total price,total liters and total bottles count of items by days (above 100 bottles) 
...
end as weekdays, item_description, sum(bottles_sold) as count_bottle, Round(sum(sale_dollars)) as total_amount, round(sum(volume_sold_liters)) as total_liter
